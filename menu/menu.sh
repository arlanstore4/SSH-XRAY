...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/arlanstore4/arlanstore4.github.io/main/wkwkwkwk > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/arlanstore4/arlanstore4.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/arlanstore4/arlanstore4.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/arlanstore4/arlanstore4.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/arlanstore4/SSH-XRAY/main/menu/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
...
serverV=$( curl -sS https://raw.githubusercontent.com/arlanstore4/SSH-XRAY/main/menu/versi )
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1 ${NC}                ${WH}• arlanstore •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1 ${NC}                 ${WH}• SEWA SCRIPT •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1 ${NC}                  ${WH}• PREMIUM •${NC}                    $COLOR1 $NC"
echo -e "$COLOR1 ${NC}             ${WH}• WA : 083805933853 •${NC}             $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
