...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/MyMasWayVPN/SSH-XRAY/main/sshws/ws-dropbear
...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/MyMasWayVPN/SSH-XRAY/main/sshws/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/MyMasWayVPN/SSH-XRAY/main/sshws/ws-stunnel
